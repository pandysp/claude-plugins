...
Plans written ad-hoc tend to forget the load-bearing pieces: existing utilities to reuse, concrete verification steps, the context that justifies the work. This skill enforces a structure that catches scope creep, missed reuse, and vague verification before any code is written. Concise enough to scan, detailed enough to execute.
