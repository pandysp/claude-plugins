...
| [dispatch-bg](./plugins/dispatch-bg) | Tooling | Dispatch background agents to the right repo, verify they landed, and read the fleet's state, progress, and results |
